...
<body>
    ...
    <?php include './inc/nav.php'; ?>
        <main>
            <form name="formulario" method="post" action="./usuarios/editar_usuario_admin.php" id="loginform" onsubmit="return validarFormulario();">
                <div class="container row justify-content-center">
                    ...
                    <div class="form-group col-8 col-md-10">
                        ...
                        <input id="ROL" type="text" class="form-control" name="ROL" value="<?php echo $fila['Rol']?>" placeholder="usuario o admin" pattern="usuario|admin" required>
                    </div>
