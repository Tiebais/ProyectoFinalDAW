...
<nav class="navbar navbar-expand-md navbar-light bg-info fixed-top" id="navbar">
    <a href="index.php" class="navbar-brand">
        <img src="./img/logoGO.png" height="28" alt="logoGO">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav">
            ...
            <a href="consolas.php" class="nav-item nav-link">Consolas</a>
            <a href="videojuegos.php" class="nav-item nav-link">Videojuegos</a>
        </div>
